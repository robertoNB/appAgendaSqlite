//
//  TableViewControllerCompra.swift
//  AppAgenda
//
...
class TableViewControllerCompra: UITableViewController {
    var Agendas = [Agenda]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celda") as! TableViewCellCompras
        let cte : Agenda
