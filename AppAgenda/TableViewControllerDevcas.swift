//
//  TableViewControllerDevcas.swift
//  AppAgenda
//
...
class TableViewControllerDevcas: UITableViewController {
    var Agendas = [Agenda]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celda") as! TableViewCellDevCas
        let cte : Agenda
